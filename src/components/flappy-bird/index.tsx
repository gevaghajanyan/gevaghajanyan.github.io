...
const closeBtn: React.CSSProperties = {
  ...
  background: 'rgba(57,211,83,0.1)', border: '1px solid rgba(57,211,83,0.35)',
  color: '#39d353', padding: '4px 10px', borderRadius: 4,
  fontFamily: 'monospace', fontSize: 11, cursor: 'pointer',
  backdropFilter: 'blur(4px)',
};

export const FlappyBirdGameComponent: React.FC<Props> = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    if (!canvas) return;
    const game = new FlappyBirdGame(canvas, canvas.getContext('2d')!);
